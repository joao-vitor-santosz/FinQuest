...
export const BillsPage = () => (
  <div className="flex w-full flex-col gap-4 sm:gap-6">
    ...
    >
      ...
      <div>
        <h1 className="text-2xl font-semibold text-white sm:text-3xl">Contas</h1>
    ...
    >
      {summaryCards.map(({ label, description, icon: Icon, accentClassName }) => (
        <section
          key={label}
    ...
    >
      ...
      <p className="mt-2 max-w-md text-sm text-text-secondary">
        Em breve, você poderá cadastrar vencimentos, recorrências e
        parcelamentos para receber alertas antes de cada pagamento.
      </p>
    </section>
  </div>
);
